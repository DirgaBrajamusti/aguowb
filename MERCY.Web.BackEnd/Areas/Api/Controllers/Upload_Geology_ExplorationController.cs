...
{
    public class Upload_Geology_ExplorationController : Controller
    {
        public JsonResult Index()
        {
            return Json("Upload_Geology_ExplorationController", JsonRequestBehavior.AllowGet);
        }
        ...
        public JsonResult ChooseFile()
        {
            ...
            if ( ! OurUtility.Upload_Record(user, fileName, fileName2, OurUtility.UPLOAD_Geology_Explorasi, ref id_File_Physical, ref msg))
            {
                var msgX = new { Success = false, Permission = permission_Item, Message = msg, MessageDetail = string.Empty, Version = Configuration.VERSION, Id = -1 };
                return Json(msgX, JsonRequestBehavior.AllowGet);
            }
            ...
            try
            {
                using (MERCY_Ctx db = new MERCY_Ctx())
                {
                    ...
                    using (SpreadsheetDocument document = SpreadsheetDocument.Open(UploadFolder + fileName, false))
                    {
                        ...
                        TEMPORARY_Geology_Explorasi_Header header = null;
                        TEMPORARY_Geology_Explorasi detail = null;
                        ...
                        foreach (Sheet sheet in wbPart.Workbook.Sheets)
                        {
                            ...
                            try
                            {
                                ...
                                header = new TEMPORARY_Geology_Explorasi_Header
                                {
                                ...
                                db.TEMPORARY_Geology_Explorasi_Header.Add(header);
                                db.SaveChanges();
                                ...
                                while (true)
                                {
                                    ...
                                    detail = new TEMPORARY_Geology_Explorasi
                                    {
                                    ...
                                    db.TEMPORARY_Geology_Explorasi.Add(detail);
                                    db.SaveChanges();
                                ...
                                try
                                {
                                    ...
                                    foreach (TEMPORARY_Geology_Explorasi row in recordSet)
                                    {
                                        ...
                                        if (db.UPLOAD_Geology_Explorasi.Where(d =>
                                                                                    d.Lab_ID == row.Lab_ID
            ...
            try
            {
                using (MERCY_Ctx db = new MERCY_Ctx())
                {
                    ...
                    using (var connection = new SqlConnection(db.Database.Connection.ConnectionString))
                    {
                        ...
                        command.CommandText = string.Format(@"exec UPLOAD_ACTUAL_GEOLOGY_EXPLORASI {0}", id);
        ...
        public static void Check_Validation(TEMPORARY_Geology_Explorasi p_detail, List<string> p_keys_Unique)
        {
                    ...
                    using (var connection = new SqlConnection(db.Database.Connection.ConnectionString))
                    {
                        ...
                        command.CommandText = string.Format(@"
                                                            ...
                                                            from TEMPORARY_File t
                                                                left join TEMPORARY_Geology_Explorasi_Header h on t.RecordId = h.File_Physical
                                                            where t.RecordId = {0}
                                                            ", file_Id);
        ...
        private void Apply_Formula_After_PROCESS_LECO(MERCY_Ctx p_db, string p_leco_Stamp)
        {
            ...
            try
            {
                var dataQuery =
                            (
                                from d in p_db.UPLOAD_Geology_Explorasi
