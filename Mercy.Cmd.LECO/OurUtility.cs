...
namespace Mercy.Cmd.LECO
{
    class OurUtility
    {
        ...
        public static string File_Read(string p_path, string p_fileName)
        {
            string result = string.Empty;

            try
            {
                result = File.ReadAllText(p_fileName);
            }
            catch (Exception ex)
            {
                result = ex.Message;
        ...
        public static void File_Delete(string p_path, string p_fileName)
        {
            string result = string.Empty;
