IF OBJECT_ID('Report_HAC_Header') IS NULL
    EXEC('CREATE PROCEDURE Report_HAC_Header AS SET NOCOUNT ON;')
GO

alter procedure [dbo].[Report_HAC_Header] @p_company varchar(32), @p_date varchar(10), @p_dateTo varchar(10)
as
begin
