...
(
	...
	/*UserType  VARCHAR(255) NOT NULL DEFAULT 'biasa',*/
...
/*drop table dbo.SamplingRequest_ROM;
drop table dbo.ROM;

drop table dbo.SamplingRequest_SEAM
drop table dbo.SEAM;
drop table dbo.PIT;*/
...
create table dbo.Instrument(
    RecordId int identity(1,1)
    , InstrumentType      varchar(255) default 'Lab Consumable'   /* 'Lab Consumable', 'Lab Maintenance' */
...
/*ALTER TABLE [User] DROP CONSTRAINT DF__User__UserType__15502E78;
ALTER TABLE [User] DROP COLUMN UserType;*/

/*ALTER TABLE SamplingRequest DROP CONSTRAINT DF__SamplingR__Tonna__628FA481;
ALTER TABLE SamplingRequest DROP COLUMN Tonnage;
ALTER TABLE SamplingRequest ADD Tonnage varchar(255) not null default '';*/
...
ALTER TABLE Consumable DROP CONSTRAINT DF__Consumabl__Stock__55DFB4D9;
ALTER TABLE Consumable DROP COLUMN StockStatus;

ALTER TABLE Consumable_History DROP CONSTRAINT DF__Consumabl__Stock__6BCEF5F8;
ALTER TABLE Consumable_History DROP COLUMN StockStatus;
...
ALTER TABLE LabMaintenance DROP CONSTRAINT DF__LabMainte__Statu__231F2AE2;
ALTER TABLE LabMaintenance DROP COLUMN Status;

ALTER TABLE LabMaintenance_History DROP CONSTRAINT DF__LabMainte__Statu__3631FF56;
ALTER TABLE LabMaintenance_History DROP COLUMN Status;
...
ALTER TABLE Instrument DROP CONSTRAINT DF__Instrumen__Instr__1FB8AE52;
ALTER TABLE Instrument DROP COLUMN InstrumentType;
...
ALTER TABLE Tunnel ADD CONSTRAINT CO_Tunnel_UNIQUE UNIQUE (Name);
go

ALTER TABLE Hopper ADD CONSTRAINT CO_Hopper_UNIQUE UNIQUE (Name);
go

/*

select * from Tunnel_Actual;

delete from Tunnel_Actual;
go

-- check Valid of Data
select * from HaulingRequest_Detail_PortionBlending
where Tunnel not in (select Name from Tunnel)
go

-- Update unnecessary data
update HaulingRequest_Detail_PortionBlending
set Tunnel = 'TN5'
where Tunnel = 'Tunnel 5';
go

-- insert into Table:Tunnel_Actual
insert into Tunnel_Actual(HaulingRequest_Reference, TunnelId, CreatedBy, CreatedOn)
select h.RecordIdx, t.TunnelId, 1, GetDate()
