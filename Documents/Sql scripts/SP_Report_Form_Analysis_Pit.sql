IF OBJECT_ID('Report_Form_Analysis_Pit') IS NULL
    EXEC('CREATE PROCEDURE Report_Form_Analysis_Pit AS SET NOCOUNT ON;')
GO

alter procedure [dbo].[Report_Form_Analysis_Pit](@p_analysisRequest int)
as
begin
    select
        [Sample_ID]
