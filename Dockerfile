...
RUN msbuild MERCY.Web.BackEnd.csproj /p:DeployOnBuild=true /p:Configuration=Release /p:PublishUrl=Publish /P:PublishProfile=FolderProfile.pubxml
...
COPY --from=build /app/MERCY.Web.BackEnd/Publish. ./