IF OBJECT_ID('PROCESS_LECO_for_GEOLOGY_PIT') IS NULL
    EXEC('CREATE PROCEDURE PROCESS_LECO_for_GEOLOGY_PIT AS SET NOCOUNT ON;')
GO

alter procedure [dbo].[PROCESS_LECO_for_GEOLOGY_PIT] @p_timeStamp datetime, @p_leco_Stamp varchar(255) output
as
begin
/*
