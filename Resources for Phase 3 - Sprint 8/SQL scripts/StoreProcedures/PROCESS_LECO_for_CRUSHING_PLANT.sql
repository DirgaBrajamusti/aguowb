IF OBJECT_ID('PROCESS_LECO_for_CRUSHING_PLANT') IS NULL
    EXEC('CREATE PROCEDURE PROCESS_LECO_for_CRUSHING_PLANT AS SET NOCOUNT ON;')
GO

alter procedure [dbo].[PROCESS_LECO_for_CRUSHING_PLANT] @p_timeStamp datetime, @p_leco_Stamp varchar(255) output
as
begin
/*
...
*/
    ...
    BEGIN TRY
        DECLARE data_1 CURSOR FOR
            select RecordId, Company, Sample_ID
        ...
        BEGIN
            -- buat Nama dengan pola: CP.TCM.XXX
            select @name = 'CP.' + @company + '.' + @id
