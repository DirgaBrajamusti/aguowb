IF OBJECT_ID('PROCESS_LECO_for_GEOLOGY_EXPLORASI') IS NULL
    EXEC('CREATE PROCEDURE PROCESS_LECO_for_GEOLOGY_EXPLORASI AS SET NOCOUNT ON;')
GO

alter procedure [dbo].[PROCESS_LECO_for_GEOLOGY_EXPLORASI] @p_timeStamp datetime, @p_leco_Stamp varchar(255) output
as
begin
/*
...
*/
    ...
    BEGIN TRY
        DECLARE data_1 CURSOR FOR
            select RecordId, Company, Lab_ID
        ...
        BEGIN
            -- buat Nama dengan pola: GE.TCM.XXX
            select @name = 'GE.' + @company + '.' + @id
            ...
            BEGIN TRY
                ...
                begin
                    ...
                    set Cal_ad = Convert(decimal(10, 2), @value_CV)
            ...
            BEGIN TRY
                ...
                begin
                    update UPLOAD_Geology_Explorasi
                    set TS = Convert(decimal(10, 2), @value_Sulfur)
                        , LECO_Stamp = @p_leco_Stamp
                    where RecordId = @id_Upload
            ...
            BEGIN TRY
                ...
                begin
                    ...
                    set M = Convert(decimal(10, 2), @value_Moisture)
                        , ASH = Convert(decimal(10, 2), @value_Ash)
                        , VM = Convert(decimal(10, 2), @value_Volatile)
                        , LECO_Stamp = @p_leco_Stamp
                    where RecordId = @id_Upload
