IF OBJECT_ID('PROCESS_Reminder_Lab_Consumable') IS NULL
    EXEC('CREATE PROCEDURE PROCESS_Reminder_Lab_Consumable AS SET NOCOUNT ON;')
GO

alter procedure [dbo].[PROCESS_Reminder_Lab_Consumable] @p_now varchar(16) = '', @p_is_Save_History int = 0
as
begin
